...
describe("converter", function()
  ...
  describe("AVAILABLE_CASES", function()
    it("should contain all case types", function()
      local cases = converter.AVAILABLE_CASES
      assert.are.equal(5, #cases)
      assert.is_true(vim.tbl_contains(cases, "snake"))
      assert.is_true(vim.tbl_contains(cases, "pascal"))
      assert.is_true(vim.tbl_contains(cases, "camel"))
      assert.is_true(vim.tbl_contains(cases, "constant"))
      assert.is_true(vim.tbl_contains(cases, "kebab"))
    end)
  end)
end)
